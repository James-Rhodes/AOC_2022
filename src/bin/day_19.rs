// Jamos you have tried to brute force come up with heruistics for this challenge and it didn't
// work. I think it is definitely time to look at DFS/Branch and Bound
